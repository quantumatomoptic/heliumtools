...
import qunits
from qunits.quantities import setrepresent
...
def test_from_string3():
    assert u.from_string('-1.158e+05 m/s kg^6.0') == -1.158e+05* u.m/u.s* u.kg**6.0
...
def test_func_decorator1():
    ...
    # Function definition
    @qunits.dimensions(rho='Mass density', v='Velocity', L='Length',
