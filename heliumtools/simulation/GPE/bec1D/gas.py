...
class Gas():
    ...
    Args:
        ...
        N_grid (int): Optional. The number of points of the computational grid. Defaults to :math:`2^8`.
    ...
    def __init__(self, element: str = "He*", N_particles: int = int(1e6),
                 ...
                 complex_dtype: torch.dtype = torch.complex128, adimensionalization_length: float = 1e-6) -> None:
    ...
    def psi(self):
        ...
        if self._updated_wavefunction == UPDATED_PSIK:
            ...
            self.psi = iftn(self._psik)[
                self.N_grid//2:self.N_grid+self.N_grid//2]
    ...
    def psi(self, value):
        ...
        self._psi = normalize_wavefunction(value, self.dx)
    ...
    def psik(self):
        ...
        if self._updated_wavefunction == UPDATED_PSI:
            ...
            self.psik = ftn(pad(self._psi, (self.N_grid//2, self.N_grid//2), mode="constant", value=0))
            self._updated_wavefunction = UPDATED_BOTH
        return self._psik
    ...
    def psik(self, value):
        if value.dtype != self.complex_dtype:
            value = value.type(self.complex_dtype)
        self._psik = normalize_wavefunction(value, self.dkx)
